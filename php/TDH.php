...
<body>
    ...
    <div class="container-content">
        <article>
            ...
            <blockquote><a name="signos">
                    <h2 id="tex4">¿Cuales son los signos o sintomas del TDH?</h2>
                </a></blockquote>
            ...
            <blockquote><a name="causas">
                    <h2 id="tex20">Causas del TDH</h2>
                </a></blockquote>
            ...
            <blockquote><a name="tips">
                    <h2 id="tex22">Tips para tratar el TDH</h2>
                </a></blockquote>
            <p>
            <ul>
