  ...
  <body>
    ...
    <div class="login-box">
      ...
      <form action="" method="post" name="login">
        ...
        <div class="col">
          <button type="button" onclick="MostrarContrasena()">Contra</button>
        </div>
