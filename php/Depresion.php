...
<body>
    ...
    <div class="container-content">
        <article>
            <blockquote><a name="que es"><h2 id="first-quote">¿Qué es la depresion?</h2></a></blockquote>
            ...
            <a name="tipos"></a>
            <blockquote><h2 id="problema1">¿Cuáles son los diferentes tipos de depresión?</h2></blockquote><br>
            ...
            <a name="signos"></a>
            <blockquote><h2 id="problema3">¿Cuáles son los signos y los síntomas de la depresión?</h2></blockquote>
            ...
            <blockquote><h2 id="problema5">¿Cómo se diagnostica la depresión?</h2></blockquote><br>
            ...
            <blockquote><h2 id="problema9">Causas</h2></blockquote><br>
            ...
            <blockquote><h2 id="problema15">¿Es igual la depresión en todas las personas?</h2></blockquote><br>
            ...
            <blockquote><h2 id="problema22">¿Cómo se trata la depresión?</h2></blockquote><br>
            ...
            <blockquote><h2 id="problema25">Medicamentos</h2></blockquote><br>
            ...
            <p id="problema29">Otra opción para la depresión resistente al tratamiento es agregar un tipo diferente de medicamento que pueda hacer que el antidepresivo sea más eficaz, como un medicamento antipsicótico o anticonvulsivo, o bien, bupropión, un antidepresivo que funciona de forma diferente a la mayoría de los medicamentos.</p><br>
             ...
             <blockquote><h2 id="problema31">Psicoterapia</h2></blockquote><br>
             ...
             <blockquote><h2 id="problema35">¿Cómo me puedo cuidar a mí mismo?</h2></blockquote><br>
             ...
             <blockquote><h2 id="problema37">¿Cómo puedo ayudar a un ser querido que está deprimido?</h2></blockquote><br>
             ...
             <blockquote><h2 id="problema39">Importante:Tome en serio los comentarios sobre el suicidio y notifíquelos al proveedor de atención médica o terapeuta de su ser querido. Si está en peligro inmediato o está pensando en hacerse daño, llame a los servicios de emergencia al 911 o diríjase a la sala de emergencias del hospital más cercano.</h2></blockquote><br>
            <img src="../img/depri1.jpg" alt="">
            <a name="tips"></a>
            <blockquote><h2 id="problema40">Dinammicas para superar la depresion</h2><br></blockquote>
