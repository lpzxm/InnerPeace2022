...
<head>
    ...
    <link rel="stylesheet" href="../css/psicologosstyle.css">
    <link rel="shortcut icon" href="../img/logo_small_icon_only.png" type="image/x-icon">
    <title>Inner Peace - Psicologos</title>
</head>
<body>
   <!--navbar-->
   <!--navbar-->
...
<a href="../php/bot.php">
   ...
   <h1 id="psico-title">Psicologos a la orden</h1>
   <p class="descripcion" id="psico-desc">El Colegio Don Bosco cuenta con estos psicologos a tu disponibilidad y a tu alcance.</p>
   <div class="general">
    <section class="card">
        <div class="card_perfil">
            <div class="card_name">
                <div class="circle"></div>
            <img src="../img/psicologo.png" class="avatar">
            <h2>Dennis Rivera</h2>
            <p id="work1">Psicologo</p>
            </div>
            <hr>
            ...
            <div class="cardbutton">
                <a class="enlaces" href="../php/plantilla 1 de psicologo.php" id="saber">Saber más</a>
            </div>
        </div>
        <div class="card_perfil">
            <div class="card_name">
            ...
            <hr>
            <div class="cardbutton">
                <a class="enlaces" href="../php/plantilla 1 de psicologo.php" id="saber2">Saber más</a>
            </div>
        </div>
        <div class="card_perfil">
            <div class="card_name">
            ...
            <hr>
            <div class="cardbutton">
                <a class="enlaces" href="../php/plantilla 1 de psicologo.php" id="saber3">Saber más</a>
            </div>
        </div>
    </section>
    <section class="card">
        <div class="card_perfil">
            ...
            <hr>
            <div class="cardbutton">
                <a class="enlaces" href="../php/plantilla 1 de psicologo.php" id="saber4">Saber más</a>
            </div>
        </div>
        <div class="card_perfil">
            <div class="card_name">
            ...
            <hr>
            <div class="cardbutton">
                <a class="enlaces" href="../php/plantilla 1 de psicologo.php" id="saber5">Saber más</a>
            </div>
        </div> 
