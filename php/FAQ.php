...
<body>
  ...
  <div class="accordion">
    <div>
      ...
      <label for="section1" class="accordion__label" id="label1">¿Qué es Inner Peace?</label>
      <hr>
    ...
    <div>
      ...
      <label for="section3" class="accordion__label" id="label2">¿Cuál es nuestra intención principal?</label>
      <hr>
      <div class="accordion__content">
        <p id="label_desc2">
    ...
    <div>
      ...
      <label for="section2" class="accordion__label" id="label3">¿Qué información proporcionamos?</label>
      <hr>
      <div class="accordion__content">
        <p id="label_desc3">
    ...
    <div>
      ...
      <label for="section4" class="accordion__label" id="label4">¿Qué es o para qué es el icono de bot que aparece en mi pantalla?</label>
      <hr>
      <div class="accordion__content">
        <p id="label_desc4">
