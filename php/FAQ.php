...
<body>
    ...
    <header class="header">
      <h1 class="header_content" id="title">Preguntas Frecuentes</h1>
      <p class="header_description" id="head_desc">Bienvenido, en este lugar encontraras solución a tus preguntas más frecuentes</p>
    </header>

    <div class="accordion">
        <div>
          <input type="checkbox" name="example_accordion" id="section1" class="accordion__input">
          <label for="section1" class="accordion__label" id="label1">¿Qué es Inner Peace?</label><hr>
          <div class="accordion__content">
            <p id="label_desc1">
              Inner Peace es una página que tiene como finalidad ayudar a los estudiantes del Colegio Don Bosco con problemas o padecimientos psícologicos.
            </p>
          </div>
        </div>
        <div>
          <input type="checkbox" name="example_accordion" id="section3" class="accordion__input">
          <label for="section3" class="accordion__label" id="label2">¿Cuál es nuestra intención principal?</label><hr>
          <div class="accordion__content">
            <p id="label_desc2">
              Nuestra intención principal es dar una mano a los jovenes que sufren de padecimientos psicologicos ante el estres estudiantil.
            </p>
          </div>
        </div>
        <div>
          <input type="checkbox" name="example_accordion" id="section2" class="accordion__input">
          <label for="section2" class="accordion__label" id="label3">¿Qué información proporcionamos?</label><hr>
          <div class="accordion__content">
            <p id="label_desc3">
              En nuestra página web, proporcionamos información acerca de los padecimientos mpas comunes en los jovenes y soluciones interactivas al alcance de la mano, también contamos con un blog con temas variados para responder cualquier duda que tú tengas.
            </p>
          </div>
        </div>
        <div>
          <input type="checkbox" name="example_accordion" id="section4" class="accordion__input">
          <label for="section4" class="accordion__label" id="label4">¿Qué es o para qué es el icono de bot que aparece en mi pantalla?</label><hr>
          <div class="accordion__content">
            <p id="label_desc4">
              El icono que aparece al lado derecho de tu pantalla, si, es un bot. Se llama PeaceBot, este sera tu asistente personal, con el cual podras interactuar, de amigo a amigo, aconsejandote de la mejor manera.
            </p>
          </div>
        </div>
      </div>
