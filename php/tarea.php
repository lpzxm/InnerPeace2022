    ...
    <div class="container">
      ...
      <div id="tasks">
        ...
        <div class="task">
            ...
            <a onclick="return confirm('Quieres borrar esta tarea?')" href="tarea .php?action=delete&id=<?php echo $t['id'] ?>" class="delete button">Borrar<i class="fa fa-trash-alt"></i></a>
        </div>
        <?php }} ?>
      </div>
    </div>
