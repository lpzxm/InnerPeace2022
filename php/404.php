...
<div class="notfound-copy">
  ...
  <h1 id="page1">Pagina no encontrada</h1>
    <p><a href="../php/Home.php" id="link1">Home</a></p>
    <p><a href="../php/InicioSesion copy.php" id="link2">Login</a></p>
</div>

<svg aria-labelledby="Starry sky" alt="Starry sky" class="starry-sky">
  <title id="svgtitle2">Inner Peace</title>
  <!-- STARS START -->
