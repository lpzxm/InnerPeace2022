    ...
    function traducir(idiomaStorage, input) {
        if(idiomaStorage){
            if (idiomaStorage.idioma == "en") {
                ...
                // title
                document.querySelector("#first-quote").innerHTML = "The losses generated by mood disorders have an impact on the productivity of a country. The losses generated by these disorders are not only important in social terms, because mental illnesses also have an enormous impact on the productivity of a country."
                document.querySelector("#problema1").innerHTML = "Depression"
                document.querySelector("#testi1").innerHTML = "Testimony of Nicole, freshman. I suffered from depression from the age of 13 to 16, it is something horrible, your whole world is upset, every part of your life and how you function in society is affected"
                document.querySelector("#testi1_1").innerHTML = "La solución fue buscar ayuda psicológica, refugiarme en mi familia, practicar deportes, leer y las actividades lúdicas, comencé a conocer e interactuar con más personas porque te encierras y el abismo se hace mucho más grande, explica."
                // footer
            ...
            if (!input.checked) {
                ...
                document.querySelector("#label_desc2").innerHTML = "Nuestra intención principal es dar una mano a los jovenes que sufren de padecimientos psicologicos ante el Estrés estudiantil."
                document.querySelector("#label3").innerHTML = "¿Qué información proporcionamos?"
                document.querySelector("#label_desc3").innerHTML = "En nuestra página web, proporcionamos información acerca de los padecimientos mpas comunes en los jovenes y soluciones interactivas al alcance de la mano, también contamos con un Testimonials con temas variados para responder cualquier duda que tú tengas."
                document.querySelector("#label4").innerHTML = "¿Qué es o para qué es el icono de bot que aparece en mi pantalla?"
                document.querySelector("#label_desc4").innerHTML = "El icono que aparece al lado derecho de tu pantalla, si, es un bot. Se llama PeaceBot, este sera tu asistente personal, con el cual podras interactuar, de amigo a amigo, aconsejandote de la mejor manera."
                // footer
                document.querySelector("#fo1").innerHTML = "Inicio"
