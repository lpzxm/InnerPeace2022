    ...
    function traducir(idiomaStorage, input) {
        if(idiomaStorage){
            if (idiomaStorage.idioma == "en") {
                ...
                document.querySelector("#head_desc").innerHTML = "Bienvenido, en este lugar encontrarás solución a tus preguntas más frecuentes."
                // Acordeon
                document.querySelector("#label1").innerHTML = "¿Qué es Inner Peace?"
                document.querySelector("#label_desc1").innerHTML = "Inner Peace es una página que tiene como finalidad ayudar a los estudiantes del Colegio Don Bosco con problemas o padecimientos psicológicos."
                document.querySelector("#label2").innerHTML = "¿Cuál es nuestra intención principal?"
                document.querySelector("#label_desc2").innerHTML = "Nuestra intención principal es dar una mano a los jóvenes que sufren de padecimientos psicológicos ante el estrés estudiantil."
                document.querySelector("#label3").innerHTML = "¿Qué información proporcionamos?"
                document.querySelector("#label_desc3").innerHTML = "En nuestro sitio web, brindamos información sobre las dolencias más comunes en los jóvenes y soluciones interactivas a su alcance, también contamos con testimonios con diversos temas para responder cualquier pregunta que pueda tener."
                document.querySelector("#label_desc4").innerHTML = "El icono que aparece al lado derecho de tu pantalla, sí, es un bot. Se llama PeaceBot, este será tu asistente personal, con el cual podrás interactuar, de amigo a amigo, aconsejándote de la mejor manera."
