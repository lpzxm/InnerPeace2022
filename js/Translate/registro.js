    ...
    function traducir(idiomaStorage, input) {
        if(idiomaStorage){
            if (idiomaStorage.idioma == "en") {
                ...
                document.querySelector("#TitleD").innerHTML = "Correo electrónico";
                document.getElementsByName('email')[0].placeholder = "Ingresa tu correo electrónico";
                document.querySelector("#TitleF").innerHTML = "Código de estudiante";
                document.getElementsByName('codigo_estudiante')[0].placeholder = "Ingresa tu código de estudiante";
                ...
                document.querySelector("#K").innerHTML = "Diseño Gráfico";
                document.querySelector("#L").innerHTML = "Electromecánica";
                document.querySelector("#M").innerHTML = "Electrónica";
                document.querySelector("#M_2").innerHTML = "Mecánica Automotriz";
                document.querySelector("#N").innerHTML = "Sección:";
                document.querySelector("#O").innerHTML = "--Seleccione su sección--";
                document.querySelector(".poli").innerHTML = "Política de privacidad";
